...
<head>
  <title>Swades Foundation login Reset Success</title>
  ...
  <div class="login-werrap">
    <div class="container">
      <div class="portal-werrap">
        <div class="row">
          <div class="col-md-12">
            <div class="portal-hd text-center">
              <img src="./assets/images/logo.svg" alt="Swades Foundation">
              <h2>Your password changed <br> successfully</h2>
            </div>
            <div class="col-md-12 group-from get-form ">
