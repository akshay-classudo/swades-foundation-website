...
<!-- End Google Tag Manager (noscript) -->
  ...
  <div class="impact-section blogs-pages">
    <div class="container">
      <div class="detail-hd">
        <span>Education</span>
        <h2>Aspiration to Achievement</h2>
      </div><!--detail-hd-->
    </div>
  </div>
    ...
    <div class="row align-items-start g-4">
      <div class="col-lg-7">
        <div class="hero-image-wrap">
          <img src="./assets/images/home/soe-edu.png" alt="" class="hero-main-img">
        </div>
      </div>
      <div class="col-lg-5">
        <h2 class="story-title">A Scholar’s Journey from Aspiration to Achievement</h2>

        <p class="story-lead">Sharvari's journey is proof of what's possible when talent meets opportunity and determination. Through the Swades Excellence Scholarship, she was able to pursue her dream of studying Neuro Physiotherapy — a field that captured her curiosity and compassion in equal measure.</p>

        <p class="story-lead">"I wanted to study this stream because it's fascinating," she says, "but more importantly, I want to be a healing hand for patients suffering from neurological conditions."</p>

        <p class="story-lead image_side">With the scholarship lifting the burden of loans or dependence, Sharvari is now stepping confidently into her role, ready to begin her career as a neuro physiotherapist. Her story reflects the power of support and self-belief — and the ripple effect of empowering one determined young mind.</p>
      </div>
    </div>
  </div>
